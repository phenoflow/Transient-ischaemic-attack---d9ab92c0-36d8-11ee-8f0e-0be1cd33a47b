...
(async () => {
  ...
  await fs.writeFile("transient-ischaemic-attack-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("transient-ischaemic-attack-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
